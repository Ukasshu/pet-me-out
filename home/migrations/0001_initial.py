# Generated by Django 2.0.4 on 2018-06-19 10:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('posAgree', models.BooleanField(default=False)),
                ('reqAgree', models.BooleanField(default=False)),
                ('startDate', models.DateField(default=None)),
                ('endDate', models.DateField(default=None)),
                ('ownerOpinion', models.CharField(blank=True, default=None, max_length=250, null=True)),
                ('ownerType', models.PositiveSmallIntegerField(blank=True, default=None, null=True)),
                ('caretakerOpinion', models.CharField(blank=True, default=None, max_length=250, null=True)),
                ('caretakerType', models.PositiveSmallIntegerField(blank=True, default=None, null=True)),
                ('caretaker', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Caretaker', to=settings.AUTH_USER_MODEL)),
                ('owner', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Owner', to=settings.AUTH_USER_MODEL)),
                ('pet', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Pet', to='home.Pet')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='stay',
            name='possibility',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Possibility', to='home.StayPossibility'),
        ),
        migrations.AddField(
            model_name='stay',
            name='request',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Request', to='home.StayRequest'),
        ),
    ]
